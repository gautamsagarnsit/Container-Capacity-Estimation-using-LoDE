...
class LoDE:
	def __init__(self, args):
		...
		f = open('{}/estimation.csv'.format(self.output_path), 'w')
		f.write('fileName,Container Id,height[mm],width[mm]\n')
		f.close()
	...
	def getObjectDimensions(self):
		...
		f = open('{}/estimation.csv'.format(self.output_path), 'a+')
		try:
			...
			print(f'Getting Object {self.args.object: 01d} Dimensions...')
			...
			f.write('id{}_l{}_b{}.png,{},{:.2f},{:.2f}\n'.format(self.args.object, self.args.lighting, self.args.background, self.args.object,height, width))
			print('Object {}, lighting {}, and background {} measured!'.format(self.args.object, self.args.lighting, self.args.background))
		
		except:
			f.write('id{}_l{}_b{}.png,{},error,error\n'.format(self.args.object, self.args.lighting, self.args.background,self.args.object))
	...
	def readData(self):			
		...
		#'{}/images/id{}_f{}_l{}_b{}_c1_rgb.png'.format(self.dataset_path, self.args.object,self.frame_idx, self.args.lighting, self.args.background)
		self.c1['rgb'] 	= cv2.imread('{}/images/id{}_f{}_l{}_b{}_c1_rgb.png'.format(self.dataset_path, self.args.object,self.args.frames, self.args.lighting, self.args.background))
		self.c1['seg'] = imageSegmentation(self.detectionModel, self.c1['rgb'])

		# Read images from Camera 2
		self.c2['rgb'] 	= cv2.imread('{}/images/id{}_f{}_l{}_b{}_c2_rgb.png'.format(self.dataset_path, self.args.object,self.args.frames, self.args.lighting, self.args.background))
...
if __name__ == '__main__':
	...
	if args.object==0:	#All objects
		for args.object in tqdm(range(1,10),total=9):
			for args.lighting in range(0,2):
				for args.background in range(0,2):
					for args.frames in range(1,6):
						try:
							lode.run()
						except:
							print("LoDE failed at:",'id{}_f{}_l{}_b{}_c1_rgb.png'.format(args.object,args.frames, args.lighting, args.background))
	else:
		lode.run()
	print('Completed!')
